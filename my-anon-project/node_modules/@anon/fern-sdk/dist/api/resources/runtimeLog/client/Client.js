...
class RuntimeLog {
   ...
   *     })
   */
  recordLog(request, requestOptions) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
      const _response = yield core.fetcher({
        ...
        requestType: "json",
        body: serializers.RuntimeLogCreateRequest.jsonOrThrow(request, {
      ...
      if (_response.ok) {
        return serializers.RecordLogResponse.parseOrThrow(_response.body, {
