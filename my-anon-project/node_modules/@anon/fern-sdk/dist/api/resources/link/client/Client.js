...
class Link {
   ...
   *     })
   */
  createLinkUrl(request, requestOptions) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (appUserIdToken != null) {
        _queryParams["appUserIdToken"] = appUserIdToken;
      }
      ...
      if (_response.ok) {
        return serializers.CreateLinkUrlResponse.parseOrThrow(_response.body, {
