...
class SdkClient {
   ...
   *     })
   */
  createSdkClient(request, requestOptions) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
      const _response = yield core.fetcher({
        ...
        requestType: "json",
        body: serializers.CreateSdkClient.jsonOrThrow(request, {
      ...
      if (_response.ok) {
        return serializers.SdkClient.parseOrThrow(_response.body, {
   ...
   *     })
   */
  getSdkClient(sdkClientId, request = {}, requestOptions) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
  ...
  listSdkClients(requestOptions) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (_response.ok) {
        return serializers.SdkClientList.parseOrThrow(_response.body, {
          unrecognizedObjectKeys: "passthrough",
          allowUnrecognizedUnionMembers: true,
          allowUnrecognizedEnumValues: true,
          breadcrumbsPrefix: ["response"],
