...
class Run {
   ...
   *     })
   */
  createCdpUrl(request, requestOptions) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
      const _response = yield core.fetcher({
        ...
        requestType: "json",
        body: serializers.CreateCdpUrlRequest.jsonOrThrow(request, {
      ...
      if (_response.ok) {
        return serializers.CreateCdpUrlResponse.parseOrThrow(_response.body, {
