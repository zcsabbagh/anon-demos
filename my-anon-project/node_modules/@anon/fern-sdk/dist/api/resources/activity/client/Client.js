...
class Activity {
   ...
   *     })
   */
  getActivityEvents(request = {}, requestOptions) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
      const { groupId, activityType } = request;
      const _queryParams = {};
      if (groupId != null) {
      ...
      if (_response.ok) {
        return serializers.ActivityEventList.parseOrThrow(_response.body, {
  ...
  createEvent(request, requestOptions) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      const _response = yield core.fetcher({
        ...
        contentType: "application/json",
        requestType: "json",
        body: serializers.CreateEventRequestBody.jsonOrThrow(request, {
   ...
   *     })
   */
  createEventWithGroupId(groupId, request, requestOptions) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
      const _response = yield core.fetcher({
        url: (0, url_join_1.default)(
          (_a = yield core.Supplier.get(this._options.environment)) !== null &&
            ...
            ? _a
            : environments.AnonApiEnvironment.Sandbox,
          `/account/api/v1/activity/${encodeURIComponent(groupId)}`,
        ),
        method: "POST",
        headers: {
          Authorization: yield this._getAuthorizationHeader(),
