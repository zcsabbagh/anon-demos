 ...
 * @param networkHelper - Helper object for network-related operations
 */
export async function navigateToDirectInbox(page, networkHelper) {
 ...
 * @param networkHelper - Helper object for network-related operations
 */
export async function closeNotificationModal(page, networkHelper) {
 ...
 */
export async function selectRecipientOnDirectMessage(page, networkHelper, recipient) {
    await networkHelper.retryWithBackoff(async () => {
 ...
 * @param message - The content of the message to be sent
 */
export async function sendMessageOnMessageModal(page, networkHelper, message) {
    await networkHelper.retryWithBackoff(async () => {
