 ...
 */
export const demoAddHeadphonesToCart = (networkHelper) => async (page) => {
 ...
 */
export const getAllOrders = (networkHelper) => async (page) => {
 ...
 */
export const searchItem = (networkHelper, item) => async (page) => {
 ...
 */
export const addItemToCartOnProductPage = async (networkHelper, page) => {
 ...
 */
export const submitCheckoutOnCheckoutPage = async (networkHelper, page) => {
    await networkHelper.retryWithBackoff(async () => {
 ...
 */
export const navigateToCheckoutPage = async (networkHelper, page) => {
 ...
 */
export const navigateToAccountPage = async (networkHelper, page) => {
 ...
 */
export const navigateToOrdersPage = async (networkHelper, page) => {
