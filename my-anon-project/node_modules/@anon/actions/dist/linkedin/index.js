 ...
 * @returns
 */
export const createPost = (networkHelper, postContent) => async (page) => {
 ...
 * @returns
 */
export const getConnections = (networkHelper) => async (page) => {
 ...
 * @returns
 */
export const followCompanyPage = (networkHelper, companyName) => async (page) => {
    try {
 ...
 * @returns
 */
export const getUserInfo = (networkHelper, personName) => async (page) => {
    try {
...
export const clickConnectButtonOnPersonPage = async (page, networkHelper) => {
    await networkHelper.waitForPageLoad(page);
...
export const fulfillConnectionRequestOnConnectionModal = async (page, networkHelper, personName, message) => {
 ...
 * @returns
 */
export async function readProfileIntroOnPersonPage(page, networkHelper) {
 ...
 * @returns
 */
export async function readContactInfoOnContactModal(page, networkHelper) {
    return await networkHelper.retryWithBackoff(async () => {
        await networkHelper.waitForNetworkIdle(page);
 ...
 * @returns
 */
export async function withContactInfoModal(page, networkHelper, operation) {
 ...
 * @returns
 */
export async function followCompanyOnCompanyPage(page, networkHelper, companyName) {
 ...
 */
export const clickOnPostModal = async (networkHelper, page) => {
 ...
 */
export const writePostContent = async (networkHelper, postContent, page) => {
 ...
 */
export const clickPostButton = async (networkHelper, page) => {
 ...
 */
export const navigateToProfile = async (networkHelper, page) => {
    // Wait for all network activity to settle
    await networkHelper.waitForNetworkIdle(page);
    await networkHelper.retryWithBackoff(async () => {
 ...
 */
export const readContactsFromConnectionPage = async (networkHelper, page) => {
    // Wait for all network activity to settle
    await networkHelper.waitForNetworkIdle(page);
 ...
 */
export const navigateToConnections = async (networkHelper, page) => {
