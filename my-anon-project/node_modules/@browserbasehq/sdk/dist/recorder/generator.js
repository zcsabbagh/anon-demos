...
class CodeGenerator extends events_1.EventEmitter {
    ...
    didPerformAction(actionInContext) {
        ...
        if (this._lastAction &&
            this._lastAction.frame.pageAlias === actionInContext.frame.pageAlias) {
    ...
    signal(pageAlias, frame, signal) {
        ...
        if (this._lastAction &&
            (!this._lastAction.committed || signal.name !== 'navigation')) {
        ...
        // @ts-ignore
        if (signal.name === 'navigation' && frame.page().mainFrame() === frame) {
            this.addAction({
                frame: {
                    pageAlias,
                    isMainFrame: true,
    ...
    generateStructure(languageGenerator) {
        ...
        const actions = this._actions
            .map((a) => languageGenerator.generateAction(a))
            .filter(Boolean);
